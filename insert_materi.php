...
<head>
    ...
    <title>Tambah Data Materi | Online Course</title>
	...
	<div class="container panel panel-default" style="display:block; margin-top:40px; 
		...
		<form method="POST" action="">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<textarea name="deskripsi" class="form-control" type="text" cols="30" rows="10"></textarea>	
				</div>
			</div>
            <div class="form-group row">
			...
			<div class="form-group row">
				<label for="" class="col-sm-2 form-label">Kursus</label>
				<div class="col-sm-10">
					<Select class="form-control form-select" name="id_kursus">
		...
		<br><br>
		<button class="btn btn-secondary"><a href="materi.php" style="text-decoration:none;"><< Kembali</a></button>
		<br><br>
	</div>
</body>
</html>
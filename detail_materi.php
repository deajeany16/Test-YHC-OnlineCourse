...
if ($_GET['id'] != NULL) {
    $id = $_GET['id'];
    $data = query("SELECT materi.id AS id_materi, materi.judul AS judul_materi, materi.deskripsi AS deskripsi_materi, link, kursus.judul AS judul_kursus FROM materi JOIN kursus ON materi.id_kursus = kursus.id WHERE materi.id_kursus = $id ORDER BY materi.judul ASC");
} else {
...
<head>
    ...
    <title>Materi Kursus | Online Course</title>
...
<body>
    ...
    <div class="container text-center">
        <div>
            ...
            <div>
                <h4 class="text-left"><a href="index.php"><< Kembali</a></h4><br>
                <table border=1 class="table table-striped table-bordered">
                    ...
                    <tr>    
                            ...
                            <td  width="200px"><?php echo $row['link'];?></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
